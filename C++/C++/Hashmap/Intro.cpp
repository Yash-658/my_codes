...
// Unordered map uses hash-table and have amortized TC of O(1) in insertion, deletiong, searching etc

// when we try to access a key which doesn't exist in the map with [], it creates the respective key with value "0"~
